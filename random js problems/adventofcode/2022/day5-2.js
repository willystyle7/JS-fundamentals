...
// After the rearrangement procedure completes, what crate ends up on top of each stack? (no reverse now when move)
...
console.log(solve(input1)); // DCVTCVPCL
