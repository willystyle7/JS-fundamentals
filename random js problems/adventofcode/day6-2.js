...
function solve(input) {
    ...
    for (let group of groups) {
        ...
        sum += Object.keys(answers).filter(answer => lines.every(line => line.indexOf(answer) >= 0)).length;
    }
    return sum;
}
...
console.log(solve(input)); // 3 + 0 + 1 + 1 + 1 = 6

let input2 = `adgvrhblps
pghsdrbmalv
hrlbpdasgv
bgvsdplahr
